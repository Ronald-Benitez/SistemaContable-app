...
@section('content')
    <div class="container py-5">
        <h1 class="text-center">eeeeeeee vegeta</h1>
        ...
        <div class="dropdown m-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="{{ route('Registro.show', ['Registro' => '8']) }}">Agosto</a></li>
        ...
        <div class="dropdown m-2">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="{{ route('mayor.show', '11') }}">Noviembre</a>
                </li>
                <li><a class="dropdown-item" href="{{ route('Registro.show', ['Registro' => '12']) }}">Diciembre</a>
                </li>
            </ul>
